...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            ...
            rect_2 (Rectangle instance): second rectangle
        Raises:
            TypeError: first rectangle is not of type Rectangle instance
            TypeError: second rectangle is not of type Rectangle instance
        Returns:
            [Rectangle instance]: biggest rectangle object
        """
    ...
    def square(cls, size=0):
        """classmethod square returns new Recatangle instance with
        width == height == size.
        Args:
